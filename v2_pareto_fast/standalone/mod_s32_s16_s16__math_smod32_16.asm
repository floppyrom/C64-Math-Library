; mod_s32_s16_s16 — exact executable source mirror for v2_pareto_fast
; Legacy API: MATH_SMOD32_16 at $3FDD
...
; Reachable instructions: 1155.
; NOTE: legacy alias entry; semantic producer is MATH_SDIV32_16.
!cpu 6510

; ---- executable island $2590 ----
* = $2590
L2590:
    jsr L9200                          ; @2590 20 00 92
    lda $4E                            ; @2593 A5 4E
...
; ---- executable island $3FDD ----
* = $3FDD
mod_s32_s16_s16:
MATH_SMOD32_16:
    jmp L3EE0                          ; @3FDD 4C E0 3E
