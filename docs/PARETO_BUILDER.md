...
|---:|---|---:|---|
| **31 B** | `atan2_fast` + V5 zero-ZP imports | **9377 B** | no |
| **36 B** | above + UMUL8 pack | **9950 B** | yes |
| **60 B** | above + record UMUL16/UMUL24 pack | **10893 B** | yes |
| **147 B** | `atan2_fast` + V5 imports + native SMUL16 | **9581 B** | yes |
| **176 B** | all active certified hybrid packs, including `atan2_fast` | **11079 B** | yes |
