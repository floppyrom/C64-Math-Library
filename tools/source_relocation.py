...
IMM_ADDR={
 'v1_balanced':{0x3000:0x8000,0x3004:0x8200,0x30B0:0x9000,0x30B8:0x8E00,0x3280:0x9000,0x3288:0x8E00,0x4800:0x8000,0x4804:0x8200,0x2000:0x8000,0x2004:0x8200,0x2100:0x8000,0x2104:0x8200,0x2300:0x9000,0x2308:0x8E00},
 'v2_pareto_fast':{0x30D0:0x7400,0x30D8:0x7200,0x3280:0x7400,0x3288:0x7200,0x3290:0x6000,0x3298:0x6200,0x32A0:0x6400,0x32A8:0x6600,0x32B0:0x6800,0x32B4:0x6A00},
 'v3_reu_512k':{0x30D0:0x7400,0x30D8:0x7200,0x3280:0x7400,0x3288:0x7200,0x3290:0x6000,0x3298:0x6200,0x32A0:0x6400,0x32A8:0x6600,0x39A0:0xC020,0x39A5:0xC020},
 'v4_reu_16m':{0x30D0:0x7400,0x30D8:0x7200,0x3280:0x7400,0x3288:0x7200,0x3290:0x6000,0x3298:0x6200,0x32A0:0x6400,0x32A8:0x6600,0x39A0:0xC020,0x39A5:0xC020},
}
IMM_LOW_PCS={0x39A0}
...
def turbo_zp_expr(profile,pc,a:int)->str|None:
 ...
 if 0x1000<=pc<0x102e and 0x0a<=a<=0xfa:
...
def operand_text(profile,pc,op,mode,raw,branch_prefix='L'):
 ...
 if mode=='imm':
  if profile in REU:
   if pc==0x1028:return ' #<TURBO32_ZP_BASE'
