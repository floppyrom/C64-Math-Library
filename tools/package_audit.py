...
ck('signed_validation_tools_shipped',all((ROOT/x).exists() for x in ('tools/validate_signed_layout.py','tools/validate_signed_multiply.py','tools/validate_signed_division.py','tools/upgrade_native_signed.py')))
