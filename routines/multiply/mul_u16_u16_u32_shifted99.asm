; UMUL16: 99 ZP bytes, 25 ordinary code bytes, 3066 table bytes.
; Exact uniform average: 155.646069282899 cycles, fresh-X entry through RTS.
...
;Min cycles: 142
;Max cycles: 185
;Avg cycles: 155.641000
;Stddev cycles: 9.211863
;ZP bytes: 99
;Code bytes: 25
;Data bytes: 3066
;Total bytes: 3091
