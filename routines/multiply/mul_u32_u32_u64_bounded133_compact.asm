...
; Firemonger kernel; compact shared bounded-carry continuation.
...
;
; Fixed layout: code reserves the bottom 162 bytes of the hardware stack page.
; Stack writes must never reach $0100..$01a1. Keep interrupt and
...
;Min cycles: 543
;Max cycles: 733
;Avg cycles: 606.864799
;Stddev cycles: 22.792481
;ZP bytes: 133
;Code bytes: 221
;Data bytes: 2044
;Total bytes: 2265
