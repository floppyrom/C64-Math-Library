; UMUL16: 106 ZP bytes, 14 ordinary code bytes, 3066 table bytes.
; Exact uniform average: 155.031478816876 cycles, fresh-X entry through RTS.
...
;Min cycles: 142
;Max cycles: 182
;Avg cycles: 155.026963
;Stddev cycles: 8.433387
;ZP bytes: 106
;Code bytes: 14
;Data bytes: 3066
;Total bytes: 3080
...
; Infrequent carry handlers in ordinary RAM; their returns use JMP.
* = $1000
cg_code_start:
p11_ram:
        sec
