; UMUL16: 116 ZP bytes, 0 ordinary code bytes, 3066 table bytes.
; Exact uniform average: 154.417078787694 cycles, fresh-X entry through RTS.
...
;Min cycles: 142
;Max cycles: 179
;Avg cycles: 154.412590
;Stddev cycles: 7.624231
;ZP bytes: 116
;Code bytes: 0
;Data bytes: 3066
;Total bytes: 3066
